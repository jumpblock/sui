...
pub fn simulate_transaction(
    ...
    // Perform budgest estimation and gas selection if requested and if VmChecks are enabled (it
    ...
    if request.do_gas_selection() && checks.enabled() {
        let budget = {
            let simulation_result = executor
                .simulate_transaction(transaction.clone(), VmChecks::Enabled,vec![])
...
impl From<crate::proto::rpc::v2alpha::simulate_transaction_request::VmChecks> for VmChecks {
    fn from(value: crate::proto::rpc::v2alpha::simulate_transaction_request::VmChecks) -> Self {
        match value {
            ...
            crate::proto::rpc::v2alpha::simulate_transaction_request::VmChecks::Disabled => {
                Self::Disabled
            }
        }
    }
